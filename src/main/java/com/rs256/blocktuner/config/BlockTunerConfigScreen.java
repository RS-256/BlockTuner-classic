            ...
            .category(ConfigCategory.createBuilder()
                ...
                .group(OptionGroup.createBuilder()
                    ...
                    .option(Option.<Boolean>createBuilder()
                        ...
                        .build())
                    .option(Option.<Boolean>createBuilder()
                        .name(Component.translatable("yacl.blocktuner.option.require_ctrl_to_copy_pitch"))
                        .description(OptionDescription.of(Component.translatable("yacl.blocktuner.option.require_ctrl_to_copy_pitch.description")))
                        .binding(true, BlockTunerConfig::isRequireCtrlToCopyPitch, BlockTunerConfig::setRequireCtrlToCopyPitch)
                        .controller(TickBoxControllerBuilder::create)
                        .build())
                    .build())
                .build())
