...
This fork was created from upstream while the upstream codebase was licensed under the GNU Lesser General Public License v3.0. Since then, this repository has not synchronized commits from upstream after the upstream project changed its license to GPLv3.

Accordingly, this repository is distributed under LGPLv3 based on the code snapshot it originally forked from. This is not intended to imply that newer upstream code or later upstream changes are available under LGPLv3.
